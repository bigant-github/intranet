...
public abstract class LifecycleMBeanBase extends LifecycleBase implements JmxEnabled {
    ...
    /**
     * Sub-classes wishing to perform additional initialization should override this method, ensuring that
     * super.initInternal() is the first call in the overriding method.
     */
    @Override
    ...
    /**
     * Sub-classes wishing to perform additional clean-up should override this method, ensuring that
     * super.destroyInternal() is the last call in the overriding method.
     */
    @Override
    ...
    /**
     * Utility method to enable sub-classes to easily register additional components that don't implement {@link
     * JmxEnabled} with an MBean server.
     * <br>
     * Note: This method should only be used once {@link #initInternal()} has been called and before {@link
     * #destroyInternal()} has been called.
     *
    ...
    protected final ObjectName register(Object obj, String objectNameKeyProperties) {
        ...
        try {
            ...
            log.warn("lifecycleMBeanBase.registerFail", e);
        } catch (Exception e) {
            log.warn("lifecycleMBeanBase.registerFail", e);
        }
    ...
    /**
     * Utility method to enable sub-classes to easily unregister additional components that don't implement {@link
     * JmxEnabled} with an MBean server.
     * <br>
     * Note: This method should only be used once {@link #initInternal()} has been called and before {@link
     * #destroyInternal()} has been called.
    ...
    protected final void unregister(ObjectName on) {
        ...
        if (mserver == null) {
            log.warn("lifecycleMBeanBase.unregisterNoServer");
            return;
        }
        ...
        try {
            ...
            log.warn("lifecycleMBeanBase.unregisterFail", e);
        }
