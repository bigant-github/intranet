 ...
 * their use.
 * <p>
 * Starting with version 1.1, this is no longer a singleton and the static methods are strongly deprecated. In a
 * container environment we can expect different applications to use different registries.
 *
