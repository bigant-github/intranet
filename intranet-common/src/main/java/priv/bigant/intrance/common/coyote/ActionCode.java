...
public enum ActionCode {
    ...
    /**
     * Execute any non-blocking dispatches that have been registered via {@link #DISPATCH_READ} or {@link
     * #DISPATCH_WRITE}. Typically required when the non-blocking listeners are configured on a thread where the
