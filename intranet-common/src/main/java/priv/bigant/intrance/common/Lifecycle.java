 ...
 *
 * </pre>
 * The {@link LifecycleEvent}s fired during state changes are defined in the methods that trigger the changed. No {@link
 * LifecycleEvent}s are fired if the attempted transition is not valid.
 *
...
public interface Lifecycle {
     ...
     * to perform configuration and need to signal when configuration should be performed - usually after {@link
     * #BEFORE_START_EVENT} and before {@link #START_EVENT}.
     */
     ...
     * perform configuration and need to signal when de-configuration should be performed - usually after {@link
     * #STOP_EVENT} and before {@link #AFTER_STOP_EVENT}.
     */
     ...
     * any child components. It is at this point that the state transitions to {@link LifecycleState#STARTING} and that
     * the public methods other than property getters/setters and life cycle methods may be used.</li>
     * <li>AFTER_START_EVENT: At the end of the method, immediately before it
     * returns. It is at this point that the state transitions to {@link LifecycleState#STARTED}.
     * </li>
     * </ol>
     *
     * @throws LifecycleException if this component detects a fatal error that prevents this component from being used
     ...
     * point that the state transitions to {@link LifecycleState#STOPPING_PREP}.</li>
     * <li>STOP_EVENT: During the method once it is safe to call stop() for
     * any child components. It is at this point that the state transitions to {@link LifecycleState#STOPPING} and that
     * the public methods other than property getters/setters and life cycle methods may no longer be used.</li>
     * <li>AFTER_STOP_EVENT: At the end of the method, immediately before it
     * returns. It is at this point that the state transitions to {@link LifecycleState#STOPPED}.
     * </li>
     * </ol>
     * <p>
     ...
     * instance that supports this interface will automatically call {@link #destroy()} after {@link #stop()}
     * completes.
     */
