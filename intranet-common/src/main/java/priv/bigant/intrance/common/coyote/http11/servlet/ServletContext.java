...
public interface ServletContext {
     ...
     *                                       web.xml file, a web-fragment.xml file nor annotated with {@link
     *                                       javax.servlet.annotation.WebListener}. For example, a {@link
     *                                       ServletContextListener} defined in a TLD would not be able to use this
     *                                       method.
     ...
     * containing<br>
     * <br>
     * /welcome.html<br> /catalog/index.html<br> /catalog/products.html<br> /catalog/offers/books.html<br>
     * /catalog/offers/music.html<br> /customer/login.jsp<br> /WEB-INF/web.xml<br> /WEB-INF/classes/com.acme.OrderServlet.class,<br>
     * <br>
     ...
     * <code>getContext</code> to obtain a
     ...
     * can provide a webmaster's email address or the name of a system that holds critical data.
     *
     ...
     * allows a servlet container to give the servlet additional information not already provided by this interface. See
     * your server documentation for information about its attributes. A list of supported attributes can be retrieved
     * using <code>getAttributeNames</code>.
     * <p>
     * The attribute is returned as a <code>java.lang.Object</code> or some subclass. Attribute names should follow the
     * same convention as package names. The Java Servlet API specification reserves names matching
    ...
    /**
     * Removes the attribute with the given name from the servlet context. After removal, subsequent calls to {@link
     ...
     * else a {@link javax.servlet.ServletRegistration.Dynamic} object that can be used to further configure the
     * servlet
     * @throws IllegalStateException         If the context has already been initialised
     * @throws UnsupportedOperationException If called from a {@link ServletContextListener#contextInitialized(ServletContextEvent)}
     *                                       method of a {@link ServletContextListener} that was not defined in a
     ...
     * else a {@link javax.servlet.FilterRegistration.Dynamic} object that can be used to further configure the filter
     * @throws UnsupportedOperationException If called from a {@link ServletContextListener#contextInitialized(ServletContextEvent)}
     *                                       method of a {@link ServletContextListener} that was not defined in a
     *                                       web.xml file, a web-fragment.xml file nor annotated with {@link
     *                                       javax.servlet.annotation.WebListener}. For example, a {@link
     ...
     * one of the connectors used by this context has the attribute <code>secure</code> set to
     * <code>true</code>.
     *
