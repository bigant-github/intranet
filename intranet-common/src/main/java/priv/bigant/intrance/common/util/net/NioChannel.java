...
public class NioChannel implements ByteChannel {
     ...
     * @return Always returns <code>true</code> since there is no network buffer in the regular channel
     ...
     * <p>
     * If a thread has been interrupted and the interrupt has not been cleared then an attempt to write to the socket
     * will fail. When this happens the socket is removed from the poller without the socket being selected. This
     * results in a connection limit leak for NIO as the endpoint expects the socket to be selected even in error
     * conditions.
     *
