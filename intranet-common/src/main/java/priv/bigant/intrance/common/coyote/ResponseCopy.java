 ...
 */
public final class ResponseCopy {

    private static final StringManager sm = StringManager.getManager(ResponseCopy.class);

    private static final Logger log = LoggerFactory.getLogger(ResponseCopy.class);
