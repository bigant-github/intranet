...
public final class HttpHeader {
    ...
    public static final int MAX_NAME_SIZE = 8192;
    ...
    /**
     * Test if the name of the header is equal to the given string. The String given must be made of lower case
     * characters.
     */
    ...
    /**
     * Test if the name of the header is equal to the given header. All the characters in the name must already be lower
     * case.
     */
    ...
    /**
     * Test if the name and value of the header is equal to the given header. All the characters in the name must
    ...
    /**
     * Return hash code. The hash code of the HttpHeader object is the same as returned by new String(name, 0,
     * nameEnd).hashCode().
     */
    public int hashCode() {
        int h = hashCode;
