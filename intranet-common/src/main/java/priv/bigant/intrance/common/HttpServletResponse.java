...
public interface HttpServletResponse {
     ...
     * invoke an error-page defined in the web application, the
    ...
    /**
     * Return the value for the specified header, or <code>null</code> if this header has not been set.  If more than
     * one value was added for this name, only the first is returned; use {@link #getHeaders(String)} to retrieve all of
     * them.
     *
