...
import priv.bigant.intrance.common.coyote.ActionHook;
...
public final class HttpResponse {
    ...
    private static final StringManager sm = StringManager.getManager(HttpResponse.class);
     ...
     * Notes.
     */
    final Object notes[] = new Object[priv.bigant.intrance.common.coyote.Constants.MAX_NOTES];
    ...
    public void setRequest(HttpResponse req) {
        this.req = req;
    }
    ...
    public void recycle() {
        ...
        contentLength = -1;
        status = HttpResponseStatus.SC_OK;
        message = null;
        committed = false;
        commitTime = -1;
        errorException = null;
