...
import priv.bigant.intrance.common.util.http.fileupload.util.mime.MimeUtility;
 ...
 * <p>
 * Parameter values are expected to be enclosed in quotes if they contain unsafe characters, such as '=' characters or
 * separators. Parameter values are optional and can be omitted.
 *
 * <p>
...
public class ParameterParser {
    ...
    /**
     * Returns {@code true} if parameter names are to be converted to lower case when name/value pairs are parsed.
     *
     * @return {@code true} if parameter names are to be converted to lower case when name/value pairs are parsed.
