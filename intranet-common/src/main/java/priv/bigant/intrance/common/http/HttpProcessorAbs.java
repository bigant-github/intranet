 ...
 * http 通信核心处理
 */
public abstract class HttpProcessorAbs implements Runnable, HttpProcessor {

    private final static Logger LOGGER = LoggerFactory.getLogger(HttpProcessorAbs.class);
    ...
    public HttpProcessorAbs(SocketBean socketBean) {
