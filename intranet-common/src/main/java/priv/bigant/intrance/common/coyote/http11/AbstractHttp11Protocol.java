...
public abstract class AbstractHttp11Protocol<S> extends AbstractProtocol<S> {
    ...
    /**
     * If an HTTP request is received that contains an illegal header name (i.e. the header name is not a token) will
     * the request be rejected (with a 400 response) or will the illegal header be ignored.
     *
    ...
    /**
     * If an HTTP request is received that contains an illegal header name (i.e. the header name is not a token) should
     * the request be rejected (with a 400 response) or should the illegal header be ignored.
     *
     * @param rejectIllegalHeaderName {@code true} to reject requests with illegal header names, {@code false} to ignore
     *                                the header
     */
    ...
    /**
     * If true, the connectionUploadTimeout will be ignored and the regular socket timeout will be used for the full
