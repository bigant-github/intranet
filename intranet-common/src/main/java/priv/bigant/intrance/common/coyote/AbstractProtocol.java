...
public abstract class AbstractProtocol<S> implements ProtocolHandler, MBeanRegistration {
     ...
     * java.security.cert.X509Certificate} it needs to be converted before it can be used and this property controls
     * which JSSE provider is used to perform the conversion. For example it is used with the AJP connectors, the HTTP
