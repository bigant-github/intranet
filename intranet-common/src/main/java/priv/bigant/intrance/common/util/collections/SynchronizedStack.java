 ...
 * requirement is to create a pool of re-usable objects with no requirement to shrink the pool. The aim is to provide
 * the bare minimum of required functionality as quickly as possible with minimum garbage.
 *
